@echo off
title Windows 10 ALL version KMS Activator &cls&echo ************************************************* &echo Copyright: Youtube: 2018Electronics and Computers &echo ************************************************* &echo.&echo Supported products:&echo - Windows 10 Home &echo - Windows 10 Professional &echo - Windows 10 Education &echo - Windows 10 Enterprise, Enterprise LTSB &echo.&echo Microsoft Windows 10 activation...
